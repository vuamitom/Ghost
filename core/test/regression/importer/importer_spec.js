        ...
        it('cares about invalid dates and date formats', function () {
            ...
            return dataImporter.doImport(exportData, importOptions)
                .then(function (importResult) {
                    ...
                    moment(importResult.data.posts[0].updated_at).utc().format().should.eql('2013-10-18T23:58:44Z');
                    moment(importResult.data.posts[0].published_at).utc().format().should.eql('2013-12-29T11:58:30Z');
                    moment(importResult.data.tags[0].updated_at).utc().format().should.eql('2016-07-17T12:02:54Z');
